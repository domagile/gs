...
public class RDR021_Step3OptionsTest extends RDRTest {
    ...
    @Test
    public void uniques_1stOccurrencesSkipEmptyCellsFirst3Columns() {
        ...
        clickFinishAndClose();
        checkResult("Master", "removeduplicaterows\\RDR_021_step3uniques_1stOccurrencesSkipEmptyCellsFirst3Columns.csv");
    }
}
